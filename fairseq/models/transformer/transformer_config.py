...
class TransformerConfig(FairseqDataclass):
    ...
    encoder: EncDecBaseConfig = field(default_factory=EncDecBaseConfig, default=EncDecBaseConfig())
    ...
    decoder: DecoderConfig = field(default_factory=DecoderConfig, default=DecoderConfig())
    ...
    quant_noise: QuantNoiseConfig = field(default_factory=QuantNoiseConfig, default=QuantNoiseConfig())
